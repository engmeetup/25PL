...
function selectLanguage(lang) {
    ...
    document.getElementById('back-btn-text').innerText = translations[lang].backBtn;
    
    // Switch fonts based on language
    const elementsToUpdateFont = [
        'main-title', 'main-subtitle', 'question-text', 
        'error-msg', 'success-title', 'success-msg', 'btn-text', 'location-title', 'back-btn-text'
    ];
...
function goBackToHome() {
    const locContainer = document.getElementById('location-view-container');
    locContainer.style.opacity = '0';
    
    setTimeout(() => {
        locContainer.classList.add('hidden');
        locContainer.classList.remove('flex', 'fade-in');
